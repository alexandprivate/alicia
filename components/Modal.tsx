...
export function Modal({ onClose }: ModalProps) {
  ...
  return (
    <div className="bg-primary/50 fixed top-0 left-0 flex items-center justify-center h-full w-full z-20 p-6 backdrop-blur-sm modal-backdrop">
      <div className="w-full p-8 max-w-3xl bg-white rounded-xl shadow-xl shadow-primary/50 relative modal">
        <button
        ...
        <div className="space-y-4 mb-8">
          ...
          <p className="leading-relaxed text-lg">
            ...
            voluptatibus autem similique. Saepe dolorem magni, nihil laudantium
            eligendi unde aliquid.
          </p>
        </div>
